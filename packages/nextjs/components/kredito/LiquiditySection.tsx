...
import { ArrowLeftIcon, BanknotesIcon, DocumentDuplicateIcon, ShieldCheckIcon } from "@heroicons/react/24/outline";
...
export const LiquiditySection = ({
  borrower,
  onBack,
  // In the dashboard the liquidity view is standalone — hide the wizard footer nav.
  embedded = false,
}: {
  borrower: `0x${string}`;
  onBack?: () => void;
